...
app.get('/player_info/post', function(req, res) {
  ...
  if (player_id != "Select Player")
    ...
    var q2 = 'SELECT * FROM football_players WHERE id = '+player_id+';'
    var q3 = 'SELECT COUNT(*) FROM football_games LEFT OUTER JOIN football_players ON ARRAY[football_players.id] <@ football_games.players WHERE football_players.id='+player_id+';'
  db.task('get-everything', task => {
    return task.batch([
        task.any(player),
        task.any(q2),
